...
rurl<-"https://www.amazon.in/OnePlus-McLaren-Limited-256GB-Storage/product-reviews/B07HGKGDHH/ref=cm_cr_dp_d_show_all_btm?ie=UTF8&reviewerType=all_reviews"
...
write.table(amazon_reviews, file = "reviews.txt", row.names = F)
